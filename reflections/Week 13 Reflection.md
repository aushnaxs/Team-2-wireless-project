This week, I contributed by researching and writing the background section of our topic, ensuing it provided clear context and supported out overall project topic. I created a pull request for the background section and revised it based on the feedback received, which was grammar. Additionally, I documented our group discussion by creating meeting notes. Finally, I updated my background progress on Overleaf, keeping our project report up to date. 
...
Reviewed the pull request on the literature review and provided feedback through the comment which was to fix sentence structures and grammar. Also, I assisted other team members on how to do a pull request.  

I used NotebookLM to help find quotes that were relevant for my background as well as ChatGPT to help improve sentence structure.
